...
nvfortran -openmp  -L${MKLROOT}/lib -lmkl_rt -lpthread -lm -ldl -liomp5 -lpthread -cudalib=cublas,nvtx,cusolver -acc -gpu=managed,lineinfo batched_zgemm.f90 -o test.exe
